...
public class Asset_Store_Offers : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        Texture2D ad1 = EditorGUIUtility.Load("Assets/GlassPack/Offer/Ads/ad1.psd") as Texture2D;
        Texture2D ad2 = EditorGUIUtility.Load("Assets/GlassPack/Offer/Ads/ad2.psd") as Texture2D;
        Texture2D ad3 = EditorGUIUtility.Load("Assets/GlassPack/Offer/Ads/ad3.psd") as Texture2D;
...
public class Startup
{
    static Startup()
    {
        EditorPrefs.SetInt("showCounts_GlassPack", EditorPrefs.GetInt("showCounts_GlassPack") + 1);       
        if (EditorPrefs.GetInt("showCounts_GlassPack") == 10)
        { 
